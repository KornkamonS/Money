 ...
 */
public class Outcome_table_dbHelper extends SQLiteOpenHelper {
    private static final int DATABASE_VERSION = 5;

    // Database Name
    private static final String DATABASE_NAME = "outcome.db";

    public Outcome_table_dbHelper(Context context ) {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String CREATE_TABLE_STUDENT = "CREATE TABLE " + Outcome_metaData.TABLE  + "("
